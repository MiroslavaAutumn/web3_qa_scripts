...
def get_factory_ref_code():
    ...
    signed_tx = web3.eth.account.signTransaction(tx, Lottery.secret.USER_PRIV)
    tx_hash = web3.eth.sendRawTransaction(signed_tx.rawTransaction)
    print('FACTORY Ref code', 'https://testnet.bscscan.com/tx/' + tx_hash.hex())


def get_lottery_ref_code(address=Lottery.secret.USER, priv=Lottery.secret.USER_PRIV, amount=0.00888):
    web3 = web3_init()
    nonce = web3.eth.getTransactionCount(address)
