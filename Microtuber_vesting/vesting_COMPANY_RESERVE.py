...
logging.basicConfig(filename='log_COMPANY_RESERVE.txt', level=logging.INFO)
logger = logging.getLogger(__name__)

address = Microtuber_vesting.preset.COMPANY_RESERVE
priv = Microtuber_vesting.preset.COMPANY_RESERVE_PRIV
