...
logging.basicConfig(filename='log_INVESTORS.txt', level=logging.INFO)
logger = logging.getLogger(__name__)

address = Microtuber_vesting.preset.INVESTORS
priv = Microtuber_vesting.preset.INVESTORS_PRIV
