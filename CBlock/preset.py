...
users = {
    priv_keys.USER: priv_keys.USER_PRIV,
    priv_keys.USER_2: priv_keys.USER_2_PRIV,
    priv_keys.USER_3: priv_keys.USER_3_PRIV,
    priv_keys.ADMIN: priv_keys.ADMIN_PRIV
}
def get_random_user():
    random_user = random.choice(list(users.keys()))
    priv = users.get(random_user)
    return random_user, priv
